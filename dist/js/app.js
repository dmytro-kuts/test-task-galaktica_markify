(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".trafic-purple__slider")) new swiper_core_Swiper(".trafic-purple__slider", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                spaceBetween: 40,
            ...
            if (document.querySelector(".trafic-yellow__slider")) new swiper_core_Swiper(".trafic-yellow__slider", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                spaceBetween: 40,
